...
} from "./chunk-QVDI67Z6.js";
import {
  require_react_dom
} from "./chunk-MAD3MDBU.js";
import {
  composeRefs,
  createSlot,
  useComposedRefs
} from "./chunk-M4XZACAI.js";
import {
  require_jsx_runtime
...
var RovingFocusGroup = React19.forwardRef(
  (props, forwardedRef) => {
...
var RovingFocusGroupImpl = React19.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React19.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection(__scopeRovingFocusGroup);
  const isClickFocusRef = React19.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React19.useState(0);
  React19.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime10.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React19.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React19.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React19.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React19.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React19.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var RemoveScroll = React27.forwardRef(function(props, parentRef) {
  ...
  return React27.createElement(
    React27.Fragment,
    null,
    enabled && React27.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  return React30.createElement(
    ...
    removeScrollBar ? React30.createElement(RemoveScrollBar, { gapMode: props.gapMode }) : null
  );
}
...
var MenuGroup = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Primitive.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Primitive.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var MenuArrow = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime11.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime12.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime12.jsx)(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
...
var DropdownMenuArrow = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime12.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
